...
export const MENU_ITEMS: MenuItemType[] = [
    ...
    children: [
      {
        ...
        parentKey: 'principal-approvals-group',
        allowedRoles: [ROLES.PRINCIPAL, ROLES.SYSTEM_ADMIN],
        isDisabled: false,
      },
      {
    ...
    children: [
      {
        ...
        parentKey: 'principal-wellbeing-group',
        allowedRoles: [ROLES.PRINCIPAL],
      },
      {
      ...
      {
        key: 'principal-wellbeing-concerns',
        label: 'Wellbeing Concerns',
        icon: HeartPulse,
        url: '/principal/wellbeing-concerns',
        parentKey: 'principal-wellbeing-group',
        allowedRoles: [ROLES.PRINCIPAL],
      },
      {
        key: 'principal-safety-alerts',
        label: 'Safety Alerts',
        icon: ShieldAlert,
        url: '/principal/safety-alerts',
        parentKey: 'principal-wellbeing-group',
        allowedRoles: [ROLES.PRINCIPAL],
      },
      {
  ...
  {
    key: 'principal-communication-group',
    label: 'Communication',
    icon: Send,
    allowedRoles: [ROLES.PRINCIPAL],
    children: [
      {
        ...
        parentKey: 'principal-communication-group',
        allowedRoles: [ROLES.PRINCIPAL],
      },
      {
  ...
  {
    key: 'principal-performance-group',
    label: 'Performance & Monitoring',
    icon: Activity,
    allowedRoles: [ROLES.PRINCIPAL, ROLES.SECTION_HEAD, ROLES.SYSTEM_ADMIN],
    children: [
      {
  ...
  {
    key: 'teacher-art-activity',
    label: 'Art & Painting Check',
    icon: Palette,
    url: '/teacher/art-activity',
    allowedRoles: [ROLES.TEACHER],
  },
  {
