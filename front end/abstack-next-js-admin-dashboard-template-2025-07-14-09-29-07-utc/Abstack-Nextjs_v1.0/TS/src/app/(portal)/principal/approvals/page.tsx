...
import type { ApprovalItemType, ApprovalQueueItem } from '@/types/sims/approval'
  ...
  return (
    <div className="container-fluid px-4 py-4">
      ...
      <div className="d-flex align-items-center gap-3 mb-4">
        ...
        <div>
          <h4 className="mb-0 fw-bold">Approval Queue</h4>
          <p className="mb-0 text-muted small">
            Unified view of all pending leave requests, fee waivers, and expense
            approvals
          </p>
        </div>
      </div>
