      ...
      <Row>
        <Col lg={6}>
          <ComponentContainerCard title="A Basic Message" description={<>Here&apos;s a basic example of SweetAlert.</>}>
            <button type="button" className="btn btn-primary" id="sweetalert-basic" onClick={() => openAlert({
        ...
        <Col lg={6}>
          <ComponentContainerCard title="Title" description={<>A Title with a Text Under.</>}>
            <button type="button" className="btn btn-primary" id="sweetalert-title" onClick={() => openAlert({
            title: 'The Internet?',
        ...
        <Col lg={6}>
          <ComponentContainerCard title="All States" description={<>Here are examples for each of SweetAlert&apos;s states.</>}>
            <div className="d-flex flex-wrap gap-2">
              <button type="button" id="sweetalert-info" onClick={() => openAlert({
              ...
              <button type="button" id="sweetalert-warning" onClick={() => openAlert({
              ...
              <button type="button" id="sweetalert-error" onClick={() => openAlert({
              ...
              <button type="button" id="sweetalert-success" onClick={() => openAlert({
              ...
              <button type="button" id="sweetalert-question" onClick={() => openAlert({
        ...
        <Col lg={6}>
          <ComponentContainerCard title="Long Content" description={<>A modal window with a long content inside.</>}>
            <button type="button" id="sweetalert-longcontent" onClick={() => openAlert({
        ...
        <Col lg={6}>
          <ComponentContainerCard title="With Confirm Button" description={<>A warning message, with a function attached to the &quot;Confirm&quot;-button...</>}>
            <button type="button" id="sweetalert-confirm-button" onClick={() => ReactSwal.fire({
            title: 'Are you sure?',
        ...
        <Col lg={6}>
          <ComponentContainerCard title="With Cancel Button" description={<>By passing a parameter, you can execute something else for &quot;Cancel&quot;.</>}>
            <button type="button" id="sweetalert-params" onClick={() => ReactSwal.fire({
            title: 'Are you sure?',
            text: "You won't be able to revert this!",
            icon: 'warning',
            showCancelButton: true,
        ...
        <Col lg={6}>
          <ComponentContainerCard title="With Image Header (Logo)" description={<>A message with custom Image Header.</>}>
            <button type="button" id="sweetalert-image" onClick={() => openAlert({
            title: 'Sweet!',
        ...
        <Col lg={6}>
          <ComponentContainerCard title="Auto Close" description={<>A message with auto close timer.</>}>
            <button type="button" id="sweetalert-close" onClick={() => ReactSwal.fire({
        ...
        <Col lg={6}>
          <ComponentContainerCard title="With Custom Padding, Background" description={<>A message with custom width, padding and background.</>}>
            <button type="button" id="custom-padding-width-alert" onClick={() => openAlert({
        ...
        <Col lg={6}>
          <ComponentContainerCard title="Ajax Request" description={<>Ajax request example.</>}>
            <button type="button" id="ajax-alert" onClick={() => ReactSwal.fire({
