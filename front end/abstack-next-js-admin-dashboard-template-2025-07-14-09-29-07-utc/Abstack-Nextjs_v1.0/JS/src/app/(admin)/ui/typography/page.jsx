...
const Typography = () => {
  return <>
      ...
      <div>
        <Row>
          <Col xs={12}>
            <ComponentContainerCard title="Display Headings" description={<>
        ...
        <Row>
          <Col xs={12}>
            <ComponentContainerCard title="Headings" description={<>
                  All HTML headings, <code>&lt;h1&gt;</code>&nbsp;through&nbsp;
                  <code>&lt;h6&gt;</code>, are available. <code>.h1</code> through <code>.h6</code>&nbsp; classes are also available, for when you
        ...
        <Row>
          ...
          <Col xl={4}>
            <ComponentContainerCard title="Unstyled" description={<>
      ...
      <Row>
        <Col xl={4}>
          <ComponentContainerCard title="Abbreviations" description={<>Add .initialism to an abbreviation for a slightly smaller font-size.</>}>
            <p>
        ...
        <Col xl={4}>
          <ComponentContainerCard title="Alignment" description={<>Use text utilities as needed to change the alignment of your blockquote.</>}>
      ...
      <Row>
        <Col xl={6}>
          <ComponentContainerCard title="Blockquotes" description={<>
                For quoting blocks of content from another source within your document. Wrap
                <code>&lt;blockquote class=&quot;blockquote&quot;&gt;</code> around any <abbr title="PacesText Markup Language">HTML</abbr> as the
                quote.
              </>}>
            <blockquote className="blockquote">
        ...
        <Col xl={6}>
          <ComponentContainerCard title="Description List Alignment" description={<>
