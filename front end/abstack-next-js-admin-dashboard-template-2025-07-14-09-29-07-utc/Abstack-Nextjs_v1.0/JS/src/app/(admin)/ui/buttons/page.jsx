...
const DefaultButtons = () => {
  return <ComponentContainerCard title="Default Buttons" description={<>
...
const ButtonOutline = () => {
  return <ComponentContainerCard title="Button Outline" description={<>
...
const ButtonRounded = () => {
  return <ComponentContainerCard title="Button-Rounded" description={<>
...
const ButtonOutlineRounded = () => {
  return <ComponentContainerCard title="Button Outline Rounded" description={<>
          Use a classes <code>.btn-outline-**</code> to quickly create a bordered buttons.
        </>}>
      <div className="d-flex flex-wrap gap-2">
...
const SoftButtons = () => {
  return <ComponentContainerCard title="Soft Buttons" description={<>
...
const SoftRoundedButtons = () => {
  return <ComponentContainerCard title="Soft Rounded Buttons" description={<>
...
const GradientButtons = () => {
  return <ComponentContainerCard title="Gradient Buttons" description={<>
          Use the button classes on an <code>&lt;a&gt;</code>, <code>&lt;button&gt;</code>, or <code>&lt;input&gt;</code> element.
        </>}>
      <div className="d-flex flex-wrap gap-2">
...
const GradientRoundedButtons = () => {
  return <ComponentContainerCard title="Gradient Rounded Buttons" description={<>
          Use a classes <code>.btn-outline-**</code> to quickly create a bordered buttons.
        </>}>
      <div className="d-flex flex-wrap gap-2">
...
const GhostButtons = () => {
  return <ComponentContainerCard title="Ghost Buttons" description={<>
...
const GhostRoundedButtons = () => {
  return <ComponentContainerCard title="Ghost Rounded Buttons" description={<>
...
const ButtonSizes = () => {
  return <ComponentContainerCard title="Button-Sizes" description={<>
...
const ButtonDisabled = () => {
  return <ComponentContainerCard title="Button-Disabled" description={<>
...
const BlockButton = () => {
  return <ComponentContainerCard title="Block Button" description={<>
...
const ButtonGroup = () => {
  return <ComponentContainerCard title="Button Group" description={<>
...
const ToggleButton = () => {
  return <ComponentContainerCard title="Toggle Button" description={<>
...
const ButtonTags = () => {
  return <ComponentContainerCard title="Button tags" description={<>
