...
const SingleButtonDropdowns = () => {
  return <ComponentContainerCard title="Single button dropdowns" description={<>
...
const CustomDropdownArrow = () => {
  return <ComponentContainerCard title="Custom Dropdown Arrow" description={<>
          Any single <code>.btn</code> can be turned into a dropdown toggle with some markup changes. Here’s how you can put them to work with either
          <code>&lt;button&gt;</code>
          elements:
        </>}>
...
const VariantDropdown = () => {
  return <ComponentContainerCard title="Variant" description={<>The best part is you can do this with any button variant, too:</>}>
      ...
      return <Dropdown className="btn-group mb-2" key={idx}>
            <DropdownToggle as={'button'} type="button" className={`btn btn-${item}`} data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              {item}
            </DropdownToggle>
            &nbsp;
            <DropdownMenu>
...
const DropupVariation = () => {
  return <ComponentContainerCard title="Dropup variation" description={<>
...
const DropendVariation = () => {
  return <ComponentContainerCard title="Dropend variation" description={<>
...
const DisabledItem = () => {
  return <ComponentContainerCard title="Disabled Item" description={<>
...
const DarkDropdowns = () => {
  return <ComponentContainerCard title="Dark dropdowns" description={<>
...
const Text = () => {
  return <ComponentContainerCard title="Text" description={<>
...
const MenuAlignment = () => {
  return <ComponentContainerCard title="Menu alignment" description={<>
...
const SplitButtonDropdowns = () => {
  return <ComponentContainerCard title="Split button dropdowns" description={<>
...
const Sizing = () => {
  return <ComponentContainerCard title="Sizing" description={<>Button dropdowns work with buttons of all sizes, including default and split dropdown buttons.</>}>
      <Dropdown className="btn-group">
...
const DropstartVariation = () => {
  return <ComponentContainerCard title="Dropstart variation" description={<>
          Trigger dropdown menus at the right of the elements by adding
...
const ActiveItem = () => {
  return <ComponentContainerCard title="Active Item" description={<>
...
const CenteredDropdowns = () => {
  return <ComponentContainerCard title="Centered dropdowns" description={<>
...
const AutoCloseBehavior = () => {
  return <ComponentContainerCard title="Auto close behavior" description={<>
...
const FormsDropdown = () => {
  return <ComponentContainerCard title="Forms" description={<>
