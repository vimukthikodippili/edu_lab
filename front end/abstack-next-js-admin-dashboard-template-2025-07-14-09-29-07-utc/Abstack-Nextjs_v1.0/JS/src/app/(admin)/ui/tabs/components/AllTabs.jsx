...
const TabsJustified = () => {
  return <ComponentContainerCard title="Tabs Justified" description={<>
...
const TabsVerticalLeft = () => {
  return <ComponentContainerCard title="Tabs Vertical Left" description={<>
...
const TabsVerticalRight = () => {
  return <ComponentContainerCard title="Tabs Vertical Right" description={<>
          You can stack your navigation by changing the flex item direction with the <code>.flex-column</code> utility.
        </>}>
      <Row>
        <TabContainer defaultActiveKey="Profile">
...
const TabsBordered = () => {
  return <ComponentContainerCard title="Tabs Bordered" description={<>
...
const IconsTabs = () => {
  return <ComponentContainerCard title="Icons Tabs" description={<>
          The navigation item can have a simple bottom border as well. Just specify the class <code>.nav-bordered</code>.
        </>}>
