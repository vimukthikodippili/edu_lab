...
const AlignmentSpinner = () => {
  return <ComponentContainerCard title="Alignment" description={<>Use flexbox utilities, float utilities, or text alignment utilities to place spinners exactly where you need them in any situation.</>}>
...
const GrowingSpinners = () => {
  return <ComponentContainerCard title="Growing Spinner" description={<>If you don&apos;t fancy a border spinner, switch to the grow spinner. While it doesn’t technically spin, it does repeatedly grow!</>}>
