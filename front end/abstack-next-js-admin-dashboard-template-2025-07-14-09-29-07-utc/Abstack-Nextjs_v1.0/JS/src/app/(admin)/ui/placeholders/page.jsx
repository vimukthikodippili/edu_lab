...
const DefaultPlaceholders = () => {
  return <ComponentContainerCard title="Placeholders" description={<>
...
const ColorPlaceholders = () => {
  return <ComponentContainerCard title="Color" description={<>
...
const WorksPlaceholder = () => {
  return <ComponentContainerCard title="How it works" description={<>
...
const AnimationPlaceholder = () => {
  return <ComponentContainerCard title="Animation" description={<>
