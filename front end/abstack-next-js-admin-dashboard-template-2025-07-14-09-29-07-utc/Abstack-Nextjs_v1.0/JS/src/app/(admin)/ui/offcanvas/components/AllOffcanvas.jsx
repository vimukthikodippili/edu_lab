...
const DefaultOffcanvas = () => {
  ...
  return <ComponentContainerCard title="Offcanvas" description={<>
...
const OffcanvasBackdrop = () => {
  ...
  return <ComponentContainerCard title="Offcanvas Backdrop" description={<>
...
const OffcanvasPlacement = () => {
  ...
  return <ComponentContainerCard title="Offcanvas Placement" description={<>
...
const DarkOffcanvas = () => {
  ...
  return <ComponentContainerCard title="Dark Offcanvas" description={<>
      ...
      <div>
        <button onClick={toggle} className="btn btn-primary mt-2 mt-md-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasDark" aria-controls="offcanvasDark">
          Dark offcanvas
        </button>
