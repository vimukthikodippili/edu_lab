...
const DismissingAlert = () => {
  return <ComponentContainerCard title="Dismissing Alert" description={<>
...
const LinkColor = () => {
  return <ComponentContainerCard title="Link Color" description={<>
...
const CustomAlerts = () => {
  return <ComponentContainerCard title="Custom Alerts" description={<>
...
const AdditionalContent = () => {
  return <ComponentContainerCard title="Additional Content" description={<> Alerts can also contain additional HTML elements like headings, paragraphs and dividers.</>}>
