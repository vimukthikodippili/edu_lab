...
const SlidesOnly = () => {
  return <ComponentContainerCard title="Slides Only" description={<>
...
const SlidesWithIndicators = () => {
  return <ComponentContainerCard title="With Indicators" description={<>You can also add the indicators to the carousel, alongside the controls, too.</>}>
...
const SlidesWithCaptions = () => {
  return <ComponentContainerCard title="With Captions" description={<>
...
const CrossFade = () => {
  return <ComponentContainerCard title="Crossfade" description={<>
...
const IndividualInterval = () => {
  return <ComponentContainerCard title="Individual Interval" description={<>
...
const DarkVariant = () => {
  return <ComponentContainerCard title="Dark Variant" description={<>
