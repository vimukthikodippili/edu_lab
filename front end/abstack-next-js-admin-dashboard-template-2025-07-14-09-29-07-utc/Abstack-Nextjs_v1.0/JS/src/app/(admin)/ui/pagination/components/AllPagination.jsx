...
const DisabledAndActive = () => {
  return <ComponentContainerCard title="Disabled and active states" description={<>
...
const CustomIconPagination = () => {
  return <ComponentContainerCard title="Custom Icon Pagination" description={<>
...
const CustomColorPagination = () => {
  return <ComponentContainerCard title="Custom Color Pagination" description={<>
          Add <code> .pagination-boxed</code> for rounded pagination.
        </>}>
      <nav>
...
const SizingPagination = () => {
  ...
  return <ComponentContainerCard title="Sizing" description={<>
...
const BoxedPagination = () => {
  return <ComponentContainerCard title="Boxed Pagination" description={<>
          Add <code> .pagination-boxed</code> for rounded pagination.
        </>}>
      <nav>
        <Pagination className="pagination-boxed">
...
const RoundedPagination = () => {
  return <ComponentContainerCard title="Rounded Pagination" description={<>
...
const SoftPagination = () => {
  return <ComponentContainerCard title="Soft Pagination" description={<>
          Add <code> .pagination-rounded</code> for rounded pagination.
        </>}>
      <nav>
...
const GradientColorPagination = () => {
  return <ComponentContainerCard title="Gradient Color Pagination" description={<>
          Add <code> .pagination-boxed</code> for rounded pagination.
        </>}>
      <nav>
