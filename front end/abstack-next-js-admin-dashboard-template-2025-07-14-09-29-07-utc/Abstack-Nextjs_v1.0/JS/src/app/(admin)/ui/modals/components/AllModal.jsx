...
const StaticBackdropModal = () => {
  ...
  return <ComponentContainerCard title="Static Backdrop" description={<>When backdrop is set to static, the modal will not close when clicking outside it. Click the button below to try it.</>}>
      <div className="d-flex flex-wrap gap-2">
