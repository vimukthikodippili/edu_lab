...
const FlushAccordions = () => {
  return <ComponentContainerCard title="Flush Accordions" description={<>
...
const BorderedAccordions = () => {
  return <ComponentContainerCard title="Bordered Accordions" description={<>
...
const CustomIconAccordion = () => {
  return <ComponentContainerCard title="Custom Icon Accordion" description={<>
          Using the card component, you can extend the default collapse behavior to create an accordion. To properly achieve the accordion style, be
          sure to use <code>.accordion</code> as a wrapper.
        </>}>
...
const AlwaysOpenAccordions = () => {
  return <ComponentContainerCard title="Always Open Accordions" description={<>
...
const AccordionWithoutArrow = () => {
  return <ComponentContainerCard title="Accordion Without Arrow" description={<>
          Using the card component, you can extend the default collapse behavior to create an accordion. To properly achieve the accordion style, be
          sure to use <code>.accordion</code> as a wrapper.
        </>}>
