...
const DefaultBadges = () => {
  return <ComponentContainerCard title="Default" description={<>
...
const ContextualVariations = () => {
  return <ComponentContainerCard title="Pill Badges" description={<>
...
const PillBadges = () => {
  return <ComponentContainerCard title="Contextual variations" description={<>
...
const BadgePositioned = () => {
  return <ComponentContainerCard title="Badge Positioned" description={<>
