...
const BackgroundColor = () => {
  return <ComponentContainerCard title="Background Color" description={<>
...
const BackgroundGradientColor = () => {
  return <ComponentContainerCard title="Background Gradient Color" description={<>
...
const SoftBackground = () => {
  return <ComponentContainerCard title="Soft Background" description={<>
...
const BackgroundAndColor = () => {
  return <ComponentContainerCard title="Color &amp; Background" description={<>
...
const ColoredLinks = () => {
  return <ComponentContainerCard title="Colored links" description={<>
...
const BackgroundOpacity = () => {
  return <ComponentContainerCard title="Background Opacity" description={<>
...
const TextColor = () => {
  return <ComponentContainerCard title="Text Color" description={<>
...
const TextOpacityColor = () => {
  return <ComponentContainerCard title="Text Opacity Color" description={<>
...
const Opacity = () => {
  return <ComponentContainerCard title="Opacity" description={<>
...
const AdditiveBorder = () => {
  return <ComponentContainerCard title="Additive(Add) Border" description={<>
...
const SubtractiveBorder = () => {
  return <ComponentContainerCard title="Subtractive(Remove) Border" description={<>
...
const BorderOpacity = () => {
  return <ComponentContainerCard title="Border Opacity" description={<>
...
const BorderRadiusSize = () => {
  return <ComponentContainerCard title="Border Radius Size" description={<>
...
const TextSelection = () => {
  return <ComponentContainerCard title="Text Selection" description={<>
...
const PointerEvents = () => {
  return <ComponentContainerCard title="Pointer Events" description={<>
...
const Overflow = () => {
  return <ComponentContainerCard title="Overflow" description={<>
...
const PositionInArrange = () => {
  return <ComponentContainerCard title="Position in Arrange" description={<>
...
const PositionCenter = () => {
  return <ComponentContainerCard title="Position in Center" description={<>
...
const PositionAxis = () => {
  return <ComponentContainerCard title="Position in Axis" description={<>
...
const Shadows = () => {
  return <ComponentContainerCard title="Shadows" description={<>
...
const Width = () => {
  return <ComponentContainerCard title="Width" description={<>
...
const ObjectFit = () => {
  return <ComponentContainerCard title="Object Fit" description={<>
...
const ZIndex = () => {
  return <ComponentContainerCard title="Z-index" description={<>
