...
const CustomContent = () => {
  ...
  return <ComponentContainerCard title="Custom content" description={<>Alternatively, you can also add additional controls and components to toasts.</>}>
...
const AllToasts = () => {
  return <>
      <div>
        <Row>
          <Col xs={12}>
            <ComponentContainerCard title="Bootstrap Toasts" description={<>Push notifications to your visitors with a toast, a lightweight and easily customizable alert message.</>}>
              <Row>
                <Basic />
                <Translucent />
              </Row>
