...
const SizingImages = () => {
  return <ComponentContainerCard title="Sizing - Images" description={<>
...
const SizingBackgroundColor = () => {
  return <ComponentContainerCard title="Sizing - Background Color" description={<>
...
const RoundedCircle = () => {
  return <ComponentContainerCard title="Rounded Circle" description={<>
...
const RoundedCircleBackground = () => {
  return <ComponentContainerCard title="Rounded Circle Background" description={<>
          Using an additional class <code>.rounded-circle</code> in <code className="me-1">&lt;img&gt;</code>
          element creates the rounded avatar.
        </>}>
      <Row>
...
const AvatarGroup = () => {
  return <ComponentContainerCard title="Avatar Group" description={<>
          Create and group avatars of different sizes and shapes with the css classes. Using Bootstrap&apos;s naming convention, you can control size
          of avatar including standard avatar, or scale it up to different sizes.
        </>}>
      <Row>
