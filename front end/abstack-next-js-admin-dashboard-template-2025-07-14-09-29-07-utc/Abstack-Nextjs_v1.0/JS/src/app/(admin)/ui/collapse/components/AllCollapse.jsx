...
const DefaultCollapse = () => {
  ...
  return <ComponentContainerCard title="Collapse" description={<>
...
const CollapseHorizontal = () => {
  ...
  return <ComponentContainerCard title="Collapse Horizontal" description={<>
...
const MultipleCollapse = () => {
  ...
  return <ComponentContainerCard title="Multiple Targets" description={<>
      ...
      <p>
        <a className="btn btn-primary" onClick={toggleFirst} data-bs-toggle="collapse" href="#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">
          Toggle first element
        </a>
        &nbsp;
        <button className="btn btn-primary" onClick={toggleSecond} type="button" data-bs-toggle="collapse" data-bs-target="#multiCollapseExample2" aria-expanded="false" aria-controls="multiCollapseExample2">
          Toggle second element
        </button>
        &nbsp;
        <button className="btn btn-primary" onClick={toggleBoth} type="button" data-bs-toggle="collapse" data-bs-target=".multi-collapse" aria-expanded="false" aria-controls="multiCollapseExample1 multiCollapseExample2">
