        ...
        <div className="border-start border-light h-100">
          <CardBody className="py-2">
            <div className="d-flex align-items-center gap-2">
              <button type="button" className="btn btn-light d-xxl-none d-flex p-1" data-bs-toggle="offcanvas" data-bs-target="#email-sidebar" onClick={composeEmail.toggle} aria-controls="email-sidebar">
              ...
              <Table className="table-hover mail-list mb-0">
                <tbody>
                  ...
                  return <tr className="position-relative" key={idx} onClick={toggle}>
                        ...
                        <td>
                          <Link data-bs-toggle="modal" href="#email-details-modal" role="button" aria-controls="email-details-modal" className="link-reset text-truncate fs-14 fw-semibold stretched-link">
                            {item.subTitle}
                          </Link>
                        </td>
                        <td>
                        ...
                        <td>
                          {item.isAttachment && <Link href="" className="link-reset text-truncate text-nowrap">
