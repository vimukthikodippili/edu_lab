...
const BasicTable = () => {
  return <ComponentContainerCard title="My Table" description={<>
...
const InverseTable = () => {
  return <ComponentContainerCard title="Inverse Table" description={<>
...
const StripedColumnsTable = () => {
  return <ComponentContainerCard title="Striped Columns" description={<>
...
const TableHeadOptions = () => {
  return <ComponentContainerCard title="Table Head Options" description={<>
...
const HoverableRows = () => {
  return <ComponentContainerCard title="Hoverable Rows" description={<>
...
const InverseHoverableRows = () => {
  return <ComponentContainerCard title="Inverse Hoverable Rows" description={<>
          Add <code>.table-hover</code> to enable a hover state on table rows within a <code>&lt;tbody&gt;</code>.
        </>}>
      <div className="table-responsive-sm">
...
const BorderedTable = () => {
  return <ComponentContainerCard title="Bordered Table" description={<>
...
const BorderedColorTable = () => {
  return <ComponentContainerCard title="Bordered Color Table" description={<>
...
const AlwaysResponsive = () => {
  return <ComponentContainerCard title="Always Responsive" description={<>
...
const BasicBorderlessTable = () => {
  return <ComponentContainerCard title="Basic Borderless Example" description={<>
...
const InverseBorderlessTable = () => {
  return <ComponentContainerCard title="Inverse Borderless Table" description={<>
          Add <code>.table-borderless</code> for a table without borders.
        </>}>
      <div className="table-responsive-sm">
...
const ActiveTables = () => {
  return <ComponentContainerCard title="Active Tables" description={<>
...
const SmallTable = () => {
  return <ComponentContainerCard title="Small Table" description={<>
...
const TableFoot = () => {
  return <ComponentContainerCard title="Table Foot" description={<>
          Add <code>.table-sm</code> to make tables more compact by cutting cell padding in half.
        </>}>
      <div className="table-responsive-sm">
        <Table className="mb-0">
...
const CaptionsTable = () => {
  return <ComponentContainerCard title="Captions" description={<>
          Add <code>.table-sm</code> to make tables more compact by cutting cell padding in half.
        </>}>
      <div className="table-responsive-sm">
        <Table className="mb-0">
...
const CaptionTopTable = () => {
  return <ComponentContainerCard title="Caption Top" description={<>
          Add <code>.table-sm</code> to make tables more compact by cutting cell padding in half.
        </>}>
      <div className="table-responsive-sm">
