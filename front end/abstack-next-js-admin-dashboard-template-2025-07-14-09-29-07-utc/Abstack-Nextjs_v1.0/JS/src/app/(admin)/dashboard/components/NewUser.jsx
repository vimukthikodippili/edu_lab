      ...
      <Row>
                  ...
                  <tbody>
                    <tr>
                      ...
                      width: 30
                        ...
                        <Dropdown>
                          <DropdownToggle href="" as={Link} className="text-muted drop-arrow-none card-drop p-0" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <Col xxl={4}>
          <Card>
            ...
            <SimplebarReactClient className="card-body" style={{
            height: 400
          }}>
