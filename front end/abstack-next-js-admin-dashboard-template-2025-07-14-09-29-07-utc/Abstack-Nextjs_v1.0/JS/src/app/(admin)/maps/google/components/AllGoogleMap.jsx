...
const GoogleTypeMap = () => {
  ...
  return <ComponentContainerCard title="Google Map Types">
      ...
      overflow: 'hidden'
        ...
        <GoogleMap mapContainerStyle={containerStyle} center={center} zoom={14} mapTypeId={google.maps.MapTypeId.SATELLITE} onLoad={onLoad} onUnmount={onUnmount}>
          <Polyline options={{
          path: polyline,
          strokeColor: "#0000FF",
          strokeOpacity: 0.8,
...
const LightStyledMap = () => {
  ...
  return <ComponentContainerCard title="Ultra Light with Labels">
      ...
      overflow: 'hidden'
        ...
        styles: mapStyles
      }} zoom={14} mapTypeId={google.maps.MapTypeId.SATELLITE} onLoad={onLoad} onUnmount={onUnmount}>
        </GoogleMap>
      </div>
    </ComponentContainerCard>;
};
