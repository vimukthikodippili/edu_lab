          ...
          <Col md={6}>
            <form action="">
              <div className="mb-3">
                ...
                <InputMask className="form-control" value={value} onChange={e => setValue(e.target.null)} mask="99/99/9999" slotChar="__/__/____" />
              ...
              <div className="mb-3">
                ...
                <InputMask type="text" className="form-control" onChange={e => setValue(e.target.null)} mask="99:99:99" slotChar="__:__:__" />
              ...
              <div className="mb-3">
                ...
                <InputMask type="text" className="form-control" onChange={e => setValue(e.target.null)} mask="99/99/9999 99:99:99" slotChar="__/__/__ __:__:__" />
