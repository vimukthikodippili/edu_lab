...
const TopbarTheme = () => {
  ...
  const modes = ['light', 'dark', 'brand', 'gradient'];
  return <>
            ...
            <div className="form-check card-radio">
              ...
              <label className="form-check-label p-0 avatar-lg w-100 bg-light" htmlFor={`topbar-color-${mode}`}>
                ...
                <span className="d-flex align-items-center justify-content-center h-100">
                  <span className={`p-2 d-inline-flex shadow rounded-circle ${mode === "brand" ? "bg-primary" : mode === "light" ? "bg-white" : mode === "dark" ? "bg-dark" : ""}`} style={mode !== "brand" && mode !== "light" && mode !== "dark" ? {
