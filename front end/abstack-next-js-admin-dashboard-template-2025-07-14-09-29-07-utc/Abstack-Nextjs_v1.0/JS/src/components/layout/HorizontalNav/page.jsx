...
const MenuItemWithChildren = ({
  ...
  return <Tag className={`${className} dropdown ${activeMenuItems.includes(item.key) ? 'active' : ''}`}>
      <Link href={''} className={` ${tag === 'div' ? 'dropdown-item' : 'nav-link'} drop-arrow-none`} id="topnav-dashboards" data-bs-toggle="dropdown" onClick={toggleMenuItem} role="button" aria-haspopup="true" aria-expanded="false">
